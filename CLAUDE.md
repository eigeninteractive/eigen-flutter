...
* **Notifier Over StateNotifier:** Use `Notifier`/`AsyncNotifier` instead of
  the legacy `StateNotifier` API.
...
* **Testing:** Riverpod providers are inherently testable. Override providers
  in tests using `ProviderScope(overrides: [...])`.
