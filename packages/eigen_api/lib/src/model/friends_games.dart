...
class FriendsGames {
  ...
  final List<GameSummary> games;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is FriendsGames &&
      other.games == games;
  ...
  factory FriendsGames.fromJson(Map<String, dynamic> json) => _$FriendsGamesFromJson(json);
