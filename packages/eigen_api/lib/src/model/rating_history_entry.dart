...
class RatingHistoryEntry {
  ...
  final num createdAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is RatingHistoryEntry &&
      other.gameId == gameId &&
      other.pool == pool &&
  ...
  factory RatingHistoryEntry.fromJson(Map<String, dynamic> json) => _$RatingHistoryEntryFromJson(json);
